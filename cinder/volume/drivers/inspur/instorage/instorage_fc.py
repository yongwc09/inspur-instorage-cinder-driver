...
class InStorageMCSFCDriver(instorage_common.InStorageMCSCommonDriver,
    ...
    @fczm_utils.AddFCZone # from Ocata, the add_fc_zone is used instead of AddFCZone
    ...
    @fczm_utils.RemoveFCZone # from Ocata, the remove_fc_zone is used instead of RemoveFCZone
